...
export default function TransactionPerUserChart({ title = "Portfolio Value Over Time" }) {
  ...
  useEffect(() => {
    ...
    const fetchUserPortfolio = async () => {
      try {
        const res = await axios.get(`${API}/portfolio/transaction/${user._id}`, {
          headers: { Authorization: `Bearer ${token}` },
        });

    console.log('trans in charts  = ', res.data)
